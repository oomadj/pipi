...
public class UserListAdapter extends RecyclerView.Adapter<UserListAdapter.UserHolder> {
    ...
    public void onBindViewHolder(@NonNull UserHolder holder, int position) {
        ...
        holder.textAge.setText(String.valueOf(user.getAge()) + context.getString(R.string.age));    //NotFoundException: String resource ID #0x12  int to string
        holder.textHeight.setText(String.valueOf(user.getHeight()) + context.getString(R.string.cm_text));
        holder.textWeight.setText(String.valueOf(user.getWeight()) + context.getString(R.string.kg_text));
